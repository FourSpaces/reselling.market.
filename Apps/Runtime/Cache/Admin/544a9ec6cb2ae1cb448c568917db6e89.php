...
<html lang="zh-cn">
   ...
   var filetypes = ["gif","jpg","png","jpeg"];
      ...
      function save(){
    		...
    		if(params.defaultCity==''){
    			Plugins.Tips({title:'信息提示',icon:'error',content:'请选择商城的默认学校!',timeout:1000});
    			return;
    		}
   ...
   <body>
      <ul id="myTab" class="nav nav-tabs wst-tab" role="tablist">
	      ...
	      <li style="display:none;" ><a href="#tabc1" role="tab" data-toggle="tab">邮件设置</a></li>
	      <li  style="display:none;" ><a href="#tabc2" role="tab" data-toggle="tab">短信设置</a></li>
	  </ul>
