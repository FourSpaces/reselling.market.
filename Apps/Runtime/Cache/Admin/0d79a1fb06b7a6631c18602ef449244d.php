    	...
    	<div class='wst-tab-item'>
	        ...
	        <table class="table table-hover table-striped table-bordered wst-form">
	           <tr>
	             ...
	             <img id='goodsImgPreview' src='<?php if($object['goodsImg'] =='' ): ?>/reselling.market/Apps/Home/View/default/img/store_default_sign.png<?php else: ?>/reselling.market/<?php echo ($object['goodsImg']); endif; ?>' width='160' height='160'/><br/>
	             </td>
	           </tr>
	           <tr>
	      ...
	      <div class='wst-tab-item'>
	       <div id='galleryImgs' class='wst-gallery-imgs'>
	           <?php if(is_array($object['gallery'])): $i = 0; $__LIST__ = $object['gallery'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="wst-gallery-img">
			       <img class="gallery-img" width='140' height='100' iv="<?php echo ($vo["goodsThumbs"]); ?>" v="<?php echo ($vo["goodsImg"]); ?>" src="/reselling.market/<?php echo ($vo["goodsThumbs"]); ?>"/>
