...
<html lang="zh-cn">
   ...
   <body class='wst-page'>
       ...
       <?php if($pArea['areaId'] !=0 ): ?>归属城市：<?php echo ($pArea['areaName']); endif; ?>
        ...
        <table class="table table-hover table-striped table-bordered wst-list">
           ...
           <tbody>
            <?php if(is_array($Page['root'])): $i = 0; $__LIST__ = $Page['root'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
               ...
               <td >
                <?php if($pArea['areaType'] == '-1'): ?><a class="btn btn-default glyphicon glyphicon-pencil" href="<?php echo U('Admin/Areas/index',array('parentId'=>$vo['areaId']));?>">查看大学列表</a>&nbsp;<?php endif; ?>
               <?php if(in_array('dqlb_02',$WST_STAFF['grant'])){ ?>
