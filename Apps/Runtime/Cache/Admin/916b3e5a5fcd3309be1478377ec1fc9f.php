...
<html>
    <head>
        ...
        <link href="/reselling.market/Apps/Admin/View/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
        <!-- Ionicons -->
        <link href="/reselling.market/Apps/Admin/View/css/ionicons.min.css" rel="stylesheet" type="text/css" />
        <!-- Theme style -->
        ...
        <script src="/reselling.market/Apps/Admin/View/js/jquery-ui.min.js" type="text/javascript"></script>
        <!-- AdminLTE App -->
        <script src="/reselling.market/Apps/Admin/View/js/AdminLTE/app.js" type="text/javascript"></script>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header bg-light-blue">
                                    <img src="/reselling.market/<?php echo session('WST_STAFF.staffPhoto');?>" class="img-circle" alt="<?php echo session('WST_STAFF.roleName');?>" />
                                    <p>
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        <div class="pull-left image">
                            <img src="/reselling.market/<?php echo session('WST_STAFF.staffPhoto');?>" class="img-circle" alt="<?php echo session('WST_STAFF.staffName');?>" />
                        </div>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
					            ...
					            <li style="display:none;"><a href="<?php echo U('Admin/Brands/index');?>" target='pageContent'>品牌管理</a></li>
					            <?php } ?>
					            ...
					            <li class="hide"><a href="<?php echo U('Admin/Goods/queryPenddingByPage');?>" target='pageContent'>商品审核</a></li>
					            <?php } ?>
                                <?php if(in_array('sppl_00',$WST_STAFF['grant'])){ ?>
					            <li class="hide"><a href="<?php echo U('Admin/GoodsAppraises/index');?>" target='pageContent'>商品评价</a></li>
					            <?php } ?>
                            </ul>
                        </li>
                        <?php } ?>
                        <?php if(in_array('ddgl_00',$WST_STAFF['grant'])){ ?>
                        <li  class="treeview hide" style="display:none;">
                            <a href="#">
                                <span>订单管理</span>
                            </a>
                            <ul class="treeview-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
					            ...
					            <li class="hide"><a href="<?php echo U('Admin/Shops/queryPeddingByPage');?>" target='pageContent' >店铺审核</a></li>
					            <?php } ?>
                            </ul>
                        </li>
                        <?php } ?>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                               ...
                               <li><a href="<?php echo U('Admin/Areas/index');?>" target='pageContent' >学校管理</a></li>
                               <?php } ?>
                               <?php if(in_array('sqlb_00',$WST_STAFF['grant'])){ ?>
					           <li style="display:none;"><a href="<?php echo U('Admin/Communitys/index');?>" target='pageContent' >学校列表</a></li>
					           <?php } ?>
                               <?php if(in_array('sqlb_01',$WST_STAFF['grant'])){ ?>
					           <li class="hide"><a href="<?php echo U('Admin/Communitys/toEdit');?>" target='pageContent' >添加社区</a></li>
					           <?php } ?>
                            </ul>
                        </li>
                        <?php } ?>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
					            ...
					            <li style="display:none;"><a href="<?php echo U('Admin/Banks/index');?>" target='pageContent'>银行管理</a></li>
					            <?php } ?>
					            <?php if(in_array('zfgl_00',$WST_STAFF['grant'])){ ?>
					            <li style="display:none;"><a href="<?php echo U('Admin/Payments/index');?>" target='pageContent'>支付管理</a></li>
					            <?php } ?>
