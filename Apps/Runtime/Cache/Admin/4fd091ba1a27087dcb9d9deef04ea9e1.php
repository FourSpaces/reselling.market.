...
<html lang="zh-cn">
   <head>
      ...
      <link rel="stylesheet" href="/reselling.market/Apps/Admin/View/css/daterangepicker/daterangepicker-bs3.css">
      <!--[if lt IE 9]>
      ...
      <script src="/reselling.market/Apps/Admin/View/js/daterangepicker.js"></script>
   ...
   <body class='wst-page'>
     <form method='post' action='<?php echo U("Admin/LogLogins/index");?>'>
       ...
       <input type='text' id='key' name='key' value='<?php echo ($startDate); ?>'/>
