...
<link rel="stylesheet" href="/reselling.market/Apps/Home/View/default/css/userorder.css" />

    <div class="wst-body"> 
       
	   <div class="wst-order-userinfo-box" style="">
	   		<div class="wst-userimg-box">
	   			<img src="<?php if(empty($WST_USER['userPhoto'])): ?>/reselling.market/Apps/Home/View/default/images/logo.png<?php else: ?>/reselling.market/<?php echo ($WST_USER['userPhoto']); endif; ?>" height="100" width="140" />
	   		</div>
	   		<div class="wst-userlogin-box">
	   			...
	   			<div class="wst-user-adr">
	   				<a style="color:#ffffff;display:none;" href="<?php echo U('Home/UserAddress/queryByPage/');?>">我的收货地址</a>&nbsp;&nbsp;&nbsp;
       ...
       <div class="wst-order-tg" style="display:none;">
       ...
       <div class="wst-mywl" style="display:none;">
       		<img src="/reselling.market/Apps/Home/View/default/images/icon_top_03.png"  /><span style="color:#ffffff;">&nbsp;&nbsp;&nbsp;&nbsp;我的物流</span>
       </div>
       				...
       				<?php if(is_array($orderList['root'])): $key1 = 0; $__LIST__ = $orderList['root'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$order): $mod = ($key1 % 2 );++$key1;?><tr >
       					<td width="150">
       						<?php if(is_array($order['goodslist'])): $key2 = 0; $__LIST__ = $order['goodslist'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$goods): $mod = ($key2 % 2 );++$key2;?><a href="<?php echo U('Home/Goods/getGoodsDetails',array('goodsId'=>$goods['goodsId']));?>">
									<img src="/reselling.market/<?php echo ($goods['goodsThums']); ?>" height="50" width="50"/>
