...
<link rel="stylesheet" href="/reselling.market/Apps/Home/View/default/css/favorites.css">
	<script>
	var statusMark = 0;
	$(function () {
                                    ...
                                    <li class="wst-goods-item">
                                      <div class="goods-img">
										<a href="{{ Think.U('Home/Goods/getGoodsDetails','goodsId='+d[i].goodsId)}}">
											<img class='lazyImg' data-original="/reselling.market/{{d[i].goodsThums}}" width="170" />
										</a>
									  </div>
                                      <div class="goods-des">
										...
										<div class="goods-buy">
											...
											<div class="goods-right">
											   <a href="javascript:addCart({{d[i].goodsId}},1,'/reselling.market/{{d[i].goodsThums}}')" class="btnCart">
                             ...
                             <li class="wst-shops-item">
                                <div class="goods-img">
									<a href="{{ Think.U('Home/Shops/toShopHome','shopId='+d[i].shopId)}}">
										<img class='lazyImg' data-original="/reselling.market/{{d[i].shopImg}}" width="170" />
									</a>
								</div>
                                <div class="goods-des">
									<div class="goods-left">
