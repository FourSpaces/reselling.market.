...
<div style="width:960px;margin:0 auto;">
    ...
    <div id="system_agreement" class="main">
        <div class='content'>
            <p class='bold center'>二手商城安装协议</p>

			<p>版权所有(c)2015,</p>
			
			<p style='margin-top:10px;'>用户须知：</p>
			
			<p style='margin-top:10px;text-indent: 2em'>感谢您选择本系统，本系统由AntFerry基于ThinkPHP 3.2开发并开源发布。本协议是您与AntFerry之间关于您使用此二手系统的法律协议。无论您是个人或组织 、盈利与否、用途如何（包括以学习和研究为目的），均需仔细阅读本协议。</p>
			
			<p style='margin-top:10px;text-indent: 2em'></p>
    ...
    <div class="main" id="system_success">
        ...
        <a href="../index.php" target="_blank" title="跳到WSTMALL首页">跳到系统首页</a>&nbsp;&nbsp;
        <a href="../index.php/Admin/index" target="_blank" title="跳到WSTMALL后台">跳到系统后台</a>
        </div>
        </div>
    </div>
    <?php }?>
